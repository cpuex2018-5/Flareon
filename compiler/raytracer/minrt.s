...
#	main program starts
	...
	mv	a2, gp
	addi	gp, gp, 8
	la	a3, read_and_network_2741
	sw	a3, 0(a2)
	lw	a3, 4(sp)
	sw	a3, 4(a2)
	mv	a4, gp
	addi	gp, gp, 12
	la	a5, read_parameter_2743
	sw	a5, 0(a4)
	sw	a2, 8(a4)
	lw	a2, 12(sp)
	sw	a2, 4(a4)
	mv	a5, gp
	addi	gp, gp, 8
	la	a6, shadow_check_and_group_2874
	sw	a6, 0(a5)
	sw	a1, 4(a5)
	mv	a6, gp
	addi	gp, gp, 12
	la	a7, shadow_check_one_or_group_2877
	sw	a7, 0(a6)
	sw	a5, 8(a6)
	sw	a3, 4(a6)
	mv	a5, gp
	addi	gp, gp, 12
	la	a7, shadow_check_one_or_matrix_2880
	sw	a7, 0(a5)
	sw	a6, 8(a5)
	sw	a1, 4(a5)
	mv	a6, gp
	addi	gp, gp, 8
	la	a7, solve_one_or_network_2887
	sw	a7, 0(a6)
	sw	a3, 4(a6)
	mv	a7, gp
	addi	gp, gp, 8
	la	s1, trace_or_matrix_2891
	sw	s1, 0(a7)
	sw	a6, 4(a7)
	mv	a6, gp
	addi	gp, gp, 12
	la	s1, judge_intersection_2895
	sw	s1, 0(a6)
	sw	a7, 8(a6)
	sw	a2, 4(a6)
	mv	a7, gp
	addi	gp, gp, 8
	la	s1, solve_one_or_network_fast_2901
	sw	s1, 0(a7)
	sw	a3, 4(a7)
	mv	a3, gp
	addi	gp, gp, 8
	la	s1, trace_or_matrix_fast_2905
	sw	s1, 0(a3)
	sw	a7, 4(a3)
	mv	a7, gp
	addi	gp, gp, 12
	la	s1, judge_intersection_fast_2909
	sw	s1, 0(a7)
	sw	a3, 8(a7)
	sw	a2, 4(a7)
	mv	a3, gp
	addi	gp, gp, 16
	la	s1, trace_reflections_2927
	sw	s1, 0(a3)
	sw	a5, 12(a3)
	sw	a2, 8(a3)
	sw	a7, 4(a3)
	...
	mv	a2, gp
	addi	gp, gp, 8
	la	a5, iter_trace_diffuse_rays_2941
	sw	a5, 0(a2)
	sw	a3, 4(a2)
	mv	a3, gp
	addi	gp, gp, 8
	la	a5, trace_diffuse_ray_80percent_2950
	sw	a5, 0(a3)
	sw	a2, 4(a3)
	mv	a5, gp
	addi	gp, gp, 8
	la	a6, calc_diffuse_using_1point_2954
	sw	a6, 0(a5)
	sw	a3, 4(a5)
	mv	a3, gp
	addi	gp, gp, 8
	la	a6, do_without_neighbors_2963
	sw	a6, 0(a3)
	sw	a5, 4(a3)
	mv	a5, gp
	addi	gp, gp, 8
	la	a6, try_exploit_neighbors_2979
	sw	a6, 0(a5)
	sw	a3, 4(a5)
	mv	a6, gp
	addi	gp, gp, 8
	la	a7, pretrace_diffuse_rays_2992
	sw	a7, 0(a6)
	sw	a2, 4(a6)
	mv	a2, gp
	addi	gp, gp, 12
	la	a7, pretrace_pixels_2995
	sw	a7, 0(a2)
	sw	s1, 8(a2)
	sw	a6, 4(a2)
	mv	a6, gp
	addi	gp, gp, 8
	la	a7, pretrace_line_3002
	sw	a7, 0(a6)
	sw	a2, 4(a6)
	mv	a2, gp
	addi	gp, gp, 12
	la	a7, scan_pixel_3006
	sw	a7, 0(a2)
	sw	a5, 8(a2)
	sw	a3, 4(a2)
	mv	a3, gp
	addi	gp, gp, 12
	la	a5, scan_line_3012
	sw	a5, 0(a3)
	sw	a2, 8(a3)
	sw	a6, 4(a3)
	mv	s11, gp
...
.iter_setup_dirvec_constants_cont_2:
	addi	a1, a1, -1
	lw	a0, 0(sp)
	call	iter_setup_dirvec_constants_2838
...
.setup_startp_constants_cont_2:
	...
	addi	a1, a0, -1
	lw	a0, 0(sp)
	call	setup_startp_constants_2843
...
.solve_each_element_fast_else_4:
	...
	lw	a1, 8(sp)
	lw	a2, 4(sp)
	call	solve_each_element_fast_2897
	b	solve_each_element_fast_ret
...
init_dirvec_constants_3056:
	...
	addi	a1, a0, -1
	lw	a0, 4(sp)
	call	init_dirvec_constants_3056
...
init_vecset_constants_3059:
	...
	lw	a0, 0(sp)
	addi	a0, a0, -1
	call	init_vecset_constants_3059
