...
vecunit_sgn_2385:
	...
	fli	fa1, l_7716
	feq	t6, fa0, fa1
	beq	t6, zero, bne_else_9742
	fli	fa0, l_7718
	b	bne_cont_9743
bne_else_9742:
	bne	a1, zero, beq_else_9744
	fli	fa1, l_7718
	fdiv	fa0, fa1, fa0
	b	beq_cont_9745
beq_else_9744:
...
beq_cont_9758:
	...
	sw	a1, 0(t6)
	li	t6, 3
	bne	a4, t6, beq_else_9759
	flw	fa0, 0(a2)
	flw	fa1, 24(sp)
	feq	t6, fa0, fa1
	beq	t6, zero, bne_else_9761
	fli	fa0, l_7716
	b	bne_cont_9762
bne_else_9761:
	feq	t6, fa0, fa1
	beq	t6, zero, bne_else_9763
	fli	fa2, l_7716
	b	bne_cont_9764
bne_else_9763:
	fle	t6, fa0, fa1
	beq	t6, zero, bne_else_9765
	fli	fa2, l_7717
	b	bne_cont_9766
bne_else_9765:
	fli	fa2, l_7718
...
bne_cont_9768:
	...
	flw	fa0, 8(a2)
	feq	t6, fa0, fa1
	beq	t6, zero, bne_else_9773
	fli	fa0, l_7716
	b	bne_cont_9774
bne_else_9773:
	feq	t6, fa0, fa1
	beq	t6, zero, bne_else_9775
	fli	fa1, l_7716
	b	bne_cont_9776
bne_else_9775:
	fle	t6, fa0, fa1
	beq	t6, zero, bne_else_9777
	fli	fa1, l_7717
	b	bne_cont_9778
bne_else_9777:
	fli	fa1, l_7718
...
beq_cont_9824:
	...
	flw	fa2, 8(sp)
	fle	t6, fa0, fa2
	beq	t6, zero, bne_else_9825
	li	a0, 0
	b	solver_second_fast_2561_ret
bne_else_9825:
	bne	a1, zero, beq_else_9826
	fsqrt	fa0, fa0
	fsub	fa0, fa1, fa0
	lw	a0, 4(sp)
	flw	fa1, 16(a0)
...
is_outside_2622:
	...
	fsub	fa2, fa2, fa3
	li	t6, 1
	bne	a2, t6, beq_else_9867
	call	is_rect_outside_2607
	b	is_outside_2622_ret
beq_else_9867:
	li	t6, 2
	bne	a2, t6, beq_else_9868
...
neighbors_exist_2725:
	...
	lw	a3, 4(a2)
	addi	a4, a1, 1
	bgt	a3, a4, ble_else_10004
	li	a0, 0
	b	neighbors_exist_2725_ret
ble_else_10004:
	bgt	a1, zero, ble_else_10005
	li	a0, 0
	b	neighbors_exist_2725_ret
ble_else_10005:
	lw	a1, 0(a2)
	addi	a2, a0, 1
	bgt	a1, a2, ble_else_10006
	li	a0, 0
	b	neighbors_exist_2725_ret
ble_else_10006:
	bgt	a0, zero, ble_else_10007
	li	a0, 0
	b	neighbors_exist_2725_ret
ble_else_10007:
	li	a0, 1
...
write_rgb_element_2747:
	...
	li	t6, 255
	bgt	a0, t6, ble_else_10015
	blt	a0, zero, bge_else_10017
	b	bge_cont_10018
bge_else_10017:
	li	a0, 0
bge_cont_10018:
...
setup_reflections_2835:
	...
	flw	fa1, 0(a4)
	fle	t6, fa0, fa1
	beq	t6, zero, bne_else_10041
	b	setup_reflections_2835_ret
bne_else_10041:
	li	t6, 1
	bne	a6, t6, beq_else_10043
	mv	a1, a3
	mv	s11, a2
	lw	ra, 0(s11)
	jalr	ra, ra, 0
...
l_8154:	# 0.000100
	.word	953267991
l_8089:	# 100000000.000000
	.word	1287568416
l_8085:	# 1000000000.000000
	.word	1315859240
l_8064:	# -0.100000
	.word	-1110651699
l_8052:	# 0.010000
