...
solver_second_2775:
	...
	lw	a1, 24(a0)
	lw	a0, 4(a0)
	bnei	a0, 3, .solver_second_cont_2
	fli	fa1, l_data_1
	fsub	fa0, fa0, fa1
...
solver_2781:
	...
	flw	fa3, 8(a3)
	fsub	fa2, fa2, fa3
	bnei	a4, 1, .solver_else_1
	call	solver_rect_2750
	b	solver_ret
.solver_else_1:
	bnei	a4, 2, .solver_else_2
...
solver_second_fast_2798:
	...
	lw	a1, 24(a0)
	lw	a0, 4(a0)
	bnei	a0, 3, .solver_second_fast_cont_2
	fli	fa1, l_data_1
	fsub	fa0, fa0, fa1
...
solver_fast_2804:
	...
	add	t6, a2, a0
	lw	a2, 0(t6)
	bnei	a5, 1, .solver_fast_else_1
	mv	a0, a3
	call	solver_rect_fast_2785
	b	solver_fast_ret
.solver_fast_else_1:
	bnei	a5, 2, .solver_fast_else_2
	mv	a1, a2
	mv	a0, a3
...
iter_setup_dirvec_constants_2834:
	...
	lw	a0, 0(a0)
	lw	a4, 4(a2)
	bnei	a4, 1, .iter_setup_dirvec_constants_else_1
	sw	a3, 4(sp)	# save
	sw	a1, 8(sp)	# save
	mv	a1, a2
...
.iter_setup_dirvec_constants_else_1:
	bnei	a4, 2, .iter_setup_dirvec_constants_else_3
	sw	a3, 4(sp)	# save
	sw	a1, 8(sp)	# save
	mv	a1, a2
...
setup_startp_constants_2839:
	...
	sw	a0, 0(sp)	# save
	sw	a1, 4(sp)	# save
	bnei	a6, 2, .setup_startp_constants_else_1
	flw	fa0, 0(a3)
	flw	fa1, 4(a3)
	flw	fa2, 8(a3)
	sw	a3, 8(sp)	# save
...
.setup_startp_constants_else_1:
	bgti	a6, 2, .setup_startp_constants_else_3
...
.setup_startp_constants_else_3:
	...
	call	quadratic_2762
	lw	a0, 12(sp)	# restore
	bnei	a0, 3, .setup_startp_constants_cont_5
	fli	fa1, l_data_1
	fsub	fa0, fa0, fa1
...
is_second_outside_2854:
	...
	lw	a1, 24(a0)
	lw	a0, 4(a0)
	bnei	a0, 3, .is_second_outside_cont_1
	fli	fa1, l_data_1
	fsub	fa0, fa0, fa1
...
is_outside_2859:
	...
	flw	fa3, 8(a2)
	fsub	fa2, fa2, fa3
	bnei	a4, 1, .is_outside_else_1
	call	is_rect_outside_2844
	b	is_outside_ret
.is_outside_else_1:
	bnei	a4, 2, .is_outside_else_2
	sw	a1, 0(sp)	# save
	mv	a0, a3
	call	veciprod2_2628
	fle	a0, fzero, fa0
...
.trace_ray_else_1:
	...
	sw	a1, 52(sp)	# save
	sw	a0, 56(sp)	# save
	bnei	a3, 1, .trace_ray_else_5
	lw	a0, 28(sp)	# restore
	call	get_nvector_rect_2907
	b	.trace_ray_cont_6
.trace_ray_else_5:
	bnei	a3, 2, .trace_ray_else_7
...
.trace_diffuse_ray_else_1:
	...
	sw	a2, 8(sp)	# save
	sw	a0, 12(sp)	# save
	bnei	a3, 1, .trace_diffuse_ray_else_3
	mv	a0, a1
	call	get_nvector_rect_2907
	b	.trace_diffuse_ray_cont_4
.trace_diffuse_ray_else_3:
	bnei	a3, 2, .trace_diffuse_ray_else_5
	call	get_nvector_plane_2909
...
pretrace_pixels_2991:
	...
	lw	a0, 20(sp)	# restore
	addi	a0, a0, 1
	blti	a0, 5, .pretrace_pixels_else_1
	addi	a2, a0, -5
...
calc_dirvec_rows_3041:
	...
	lw	a1, 8(sp)	# restore
	addi	a1, a1, 2
	blti	a1, 5, .calc_dirvec_rows_cont_1
	addi	a1, a1, -5
