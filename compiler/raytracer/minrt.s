...
.read_net_item_else_1:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_net_item_else_2
	addi	a0, a2, 1
	call	min_caml_create_array
...
.read_net_item_else_2:
	...
	sw	a2, 12(sp)	# save
	li	t6, -1
	bne	a0, t6, .read_net_item_else_4
	addi	a0, a1, 1
	mv	a1, a3
	call	min_caml_create_array
...
.read_net_item_else_4:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_net_item_else_6
	addi	a0, a3, 1
	call	min_caml_create_array
...
.read_net_item_else_6:
	...
	sw	a3, 28(sp)	# save
	li	t6, -1
	bne	a0, t6, .read_net_item_else_8
	addi	a0, a1, 1
	mv	a1, a4
	call	min_caml_create_array
...
.read_net_item_else_8:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_net_item_else_10
	addi	a0, a4, 1
	call	min_caml_create_array
...
.read_net_item_else_10:
	...
	sw	a4, 44(sp)	# save
	li	t6, -1
	bne	a0, t6, .read_net_item_else_12
	addi	a0, a1, 1
	mv	a1, a5
	call	min_caml_create_array
...
.read_net_item_else_12:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_net_item_else_14
	addi	a0, a5, 1
	call	min_caml_create_array
...
.read_or_network_else_1:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_3
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	mv	a0, gp
	addi	gp, gp, 8
...
.read_or_network_else_3:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_5
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	mv	a0, gp
...
.read_or_network_else_5:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_7
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_or_network_else_7:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_9
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_or_network_else_9:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_11
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_or_network_else_11:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_13
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_or_network_cont_2:
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .read_or_network_else_15
	lw	a0, 0(sp)	# restore
	addi	a0, a0, 1
	call	min_caml_create_array
...
.read_or_network_else_15:
	...
	sw	a2, 36(sp)	# save
	li	t6, -1
	bne	a0, t6, .read_or_network_else_16
	sw	a3, 0(gp)
	mv	a0, gp
	addi	gp, gp, 4
	mv	a1, a0
...
.read_or_network_else_16:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_18
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	mv	a0, gp
	addi	gp, gp, 8
...
.read_or_network_else_18:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_20
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	mv	a0, gp
...
.read_or_network_else_20:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_22
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	sw	a3, 12(gp)
...
.read_or_network_else_22:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_24
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	sw	a3, 12(gp)
...
.read_or_network_else_24:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_26
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	sw	a3, 12(gp)
...
.read_or_network_cont_17:
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .read_or_network_else_28
	lw	a0, 36(sp)	# restore
	addi	a0, a0, 1
	call	min_caml_create_array
...
.read_or_network_else_28:
	...
	sw	a2, 68(sp)	# save
	li	t6, -1
	bne	a0, t6, .read_or_network_else_30
	sw	a3, 0(gp)
	mv	a0, gp
	addi	gp, gp, 4
	mv	a1, a0
...
.read_or_network_else_30:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_32
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	mv	a0, gp
	addi	gp, gp, 8
...
.read_or_network_else_32:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_34
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	mv	a0, gp
...
.read_or_network_else_34:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_36
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	sw	a3, 12(gp)
...
.read_or_network_else_36:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_38
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	sw	a3, 12(gp)
...
.read_or_network_cont_31:
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .read_or_network_else_40
	lw	a0, 68(sp)	# restore
	addi	a0, a0, 1
	call	min_caml_create_array
...
.read_or_network_else_40:
	...
	sw	a2, 96(sp)	# save
	li	t6, -1
	bne	a0, t6, .read_or_network_else_42
	sw	a3, 0(gp)
	mv	a0, gp
	addi	gp, gp, 4
	mv	a1, a0
...
.read_or_network_else_42:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_44
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	mv	a0, gp
	addi	gp, gp, 8
...
.read_or_network_else_44:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_46
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	mv	a0, gp
...
.read_or_network_else_46:
	...
	li	a3, -1
	li	t6, -1
	bne	a0, t6, .read_or_network_else_48
	sw	a3, 0(gp)
	sw	a3, 4(gp)
	sw	a3, 8(gp)
	sw	a3, 12(gp)
...
.read_or_network_cont_43:
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .read_or_network_else_50
	lw	a0, 96(sp)	# restore
	addi	a0, a0, 1
	call	min_caml_create_array
...
read_and_network_2737:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_1
	sw	a1, 0(gp)
	mv	a0, gp
	addi	gp, gp, 4
...
.read_and_network_else_1:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_3
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	mv	a0, gp
	addi	gp, gp, 8
...
.read_and_network_else_3:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_5
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	mv	a0, gp
...
.read_and_network_else_5:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_7
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_else_7:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_9
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_else_9:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_11
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_else_11:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_13
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_cont_2:
	lw	a1, 0(a0)
	li	t6, -1
	bne	a1, t6, .read_and_network_else_15
...
.read_and_network_else_15:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_17
	sw	a1, 0(gp)
	mv	a0, gp
	addi	gp, gp, 4
...
.read_and_network_else_17:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_19
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	mv	a0, gp
	addi	gp, gp, 8
...
.read_and_network_else_19:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_21
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	mv	a0, gp
...
.read_and_network_else_21:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_23
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_else_23:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_25
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_else_25:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_27
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_cont_18:
	lw	a1, 0(a0)
	li	t6, -1
	bne	a1, t6, .read_and_network_else_29
	b	read_and_network_ret
.read_and_network_else_29:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_31
	sw	a1, 0(gp)
	mv	a0, gp
	addi	gp, gp, 4
...
.read_and_network_else_31:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_33
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	mv	a0, gp
	addi	gp, gp, 8
...
.read_and_network_else_33:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_35
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	mv	a0, gp
...
.read_and_network_else_35:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_37
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_else_37:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_39
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_cont_32:
	lw	a1, 0(a0)
	li	t6, -1
	bne	a1, t6, .read_and_network_else_41
	b	read_and_network_ret
.read_and_network_else_41:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_43
	sw	a1, 0(gp)
	mv	a0, gp
	addi	gp, gp, 4
...
.read_and_network_else_43:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_45
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	mv	a0, gp
	addi	gp, gp, 8
...
.read_and_network_else_45:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_47
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	mv	a0, gp
...
.read_and_network_else_47:
	...
	li	a1, -1
	li	t6, -1
	bne	a0, t6, .read_and_network_else_49
	sw	a1, 0(gp)
	sw	a1, 4(gp)
	sw	a1, 8(gp)
	sw	a1, 12(gp)
...
.read_and_network_cont_44:
	lw	a1, 0(a0)
	li	t6, -1
	bne	a1, t6, .read_and_network_else_51
	b	read_and_network_ret
...
.solver_rect_cont_3:
	...
	fsw	fa3, 0(a2)
	li	a2, 1
	b	.solver_rect_cont_7
.solver_rect_else_6:
	li	a2, 0
.solver_rect_cont_7:
	b	.solver_rect_cont_5
.solver_rect_else_4:
	li	a2, 0
.solver_rect_cont_5:
...
.solver_rect_cont_11:
	...
	fsw	fa3, 0(a2)
	li	a2, 1
	b	.solver_rect_cont_15
.solver_rect_else_14:
	li	a2, 0
.solver_rect_cont_15:
	b	.solver_rect_cont_13
.solver_rect_else_12:
	li	a2, 0
.solver_rect_cont_13:
...
.solver_rect_cont_19:
	...
	fsw	fa2, 0(a0)
	li	a0, 1
	b	.solver_rect_cont_23
.solver_rect_else_22:
	li	a0, 0
.solver_rect_cont_23:
	b	.solver_rect_cont_21
.solver_rect_else_20:
	li	a0, 0
.solver_rect_cont_21:
	b	.solver_rect_cont_18
.solver_rect_else_17:
	li	a0, 0
.solver_rect_cont_18:
...
.check_all_inside_cont_3:
	...
	lw	a2, 0(t6)
	li	t6, -1
	bne	a2, t6, .check_all_inside_else_16
	li	a0, 1
	b	check_all_inside_ret
.check_all_inside_else_16:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .check_all_inside_else_18
	li	a0, 1
	b	check_all_inside_ret
...
.check_all_inside_cont_20:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .check_all_inside_else_33
	li	a0, 1
	b	check_all_inside_ret
...
.shadow_check_and_group_else_2:
	...
	fsw	fa0, 0(a0)
	li	a0, 1
	b	.shadow_check_and_group_cont_7
.shadow_check_and_group_else_6:
	li	a0, 0
.shadow_check_and_group_cont_7:
...
.shadow_check_and_group_else_10:
	...
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .shadow_check_and_group_else_12
	li	a0, 1
...
.shadow_check_and_group_else_12:
	...
	lw	a0, 4(a1)
	li	t6, -1
	bne	a0, t6, .shadow_check_and_group_else_16
	li	a0, 1
...
.shadow_check_and_group_cont_19:
	...
	lw	a0, 8(a1)
	li	t6, -1
	bne	a0, t6, .shadow_check_and_group_else_33
	li	a0, 1
...
.shadow_check_and_group_else_33:
	...
	lw	a1, 4(sp)	# restore
	call	check_all_inside_2864
	b	.shadow_check_and_group_cont_36
.shadow_check_and_group_else_35:
	li	a0, 0
.shadow_check_and_group_cont_36:
...
.shadow_check_one_or_group_else_1:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_group_else_3
	li	a0, 0
	b	shadow_check_one_or_group_ret
.shadow_check_one_or_group_else_3:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_group_else_5
	li	a0, 0
	b	shadow_check_one_or_group_ret
.shadow_check_one_or_group_else_5:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_group_else_7
	li	a0, 0
	b	shadow_check_one_or_group_ret
.shadow_check_one_or_group_else_7:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_group_else_9
	li	a0, 0
	b	shadow_check_one_or_group_ret
.shadow_check_one_or_group_else_9:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_group_else_11
	li	a0, 0
	b	shadow_check_one_or_group_ret
.shadow_check_one_or_group_else_11:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_group_else_13
	li	a0, 0
	b	shadow_check_one_or_group_ret
.shadow_check_one_or_group_else_13:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_group_else_15
	li	a0, 0
	b	shadow_check_one_or_group_ret
...
shadow_check_one_or_matrix_2876:
	...
	lw	a3, 0(a2)
	li	t6, -1
	bne	a3, t6, .shadow_check_one_or_matrix_else_1
	li	a0, 0
...
.shadow_check_one_or_matrix_else_1:
	...
	sw	a0, 8(sp)	# save
	li	t6, 99
	bne	a3, t6, .shadow_check_one_or_matrix_else_2
	li	a0, 1
...
.shadow_check_one_or_matrix_else_10:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_14
	li	a0, 0
...
.shadow_check_one_or_matrix_else_14:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_18
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_19
.shadow_check_one_or_matrix_else_18:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_22
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_23
.shadow_check_one_or_matrix_else_22:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_26
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_27
.shadow_check_one_or_matrix_else_26:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_30
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_31
.shadow_check_one_or_matrix_else_30:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_34
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_35
.shadow_check_one_or_matrix_else_34:
	...
	lw	a1, 28(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_38
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_39
.shadow_check_one_or_matrix_else_38:
	...
	lw	a1, 0(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.shadow_check_one_or_matrix_cont_41
.shadow_check_one_or_matrix_else_40:
	li	a0, 1
.shadow_check_one_or_matrix_cont_41:
.shadow_check_one_or_matrix_cont_39:
	b	.shadow_check_one_or_matrix_cont_37
.shadow_check_one_or_matrix_else_36:
	li	a0, 1
.shadow_check_one_or_matrix_cont_37:
.shadow_check_one_or_matrix_cont_35:
	b	.shadow_check_one_or_matrix_cont_33
.shadow_check_one_or_matrix_else_32:
	li	a0, 1
.shadow_check_one_or_matrix_cont_33:
.shadow_check_one_or_matrix_cont_31:
	b	.shadow_check_one_or_matrix_cont_29
.shadow_check_one_or_matrix_else_28:
	li	a0, 1
.shadow_check_one_or_matrix_cont_29:
.shadow_check_one_or_matrix_cont_27:
	b	.shadow_check_one_or_matrix_cont_25
.shadow_check_one_or_matrix_else_24:
	li	a0, 1
.shadow_check_one_or_matrix_cont_25:
.shadow_check_one_or_matrix_cont_23:
	b	.shadow_check_one_or_matrix_cont_21
.shadow_check_one_or_matrix_else_20:
	li	a0, 1
.shadow_check_one_or_matrix_cont_21:
.shadow_check_one_or_matrix_cont_19:
...
.shadow_check_one_or_matrix_cont_15:
	...
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_43
.shadow_check_one_or_matrix_else_42:
	li	a0, 1
.shadow_check_one_or_matrix_cont_43:
...
.shadow_check_one_or_matrix_cont_3:
	...
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .shadow_check_one_or_matrix_else_45
	li	a0, 0
	b	shadow_check_one_or_matrix_ret
.shadow_check_one_or_matrix_else_45:
	sw	a1, 16(sp)	# save
	li	t6, 99
	bne	a0, t6, .shadow_check_one_or_matrix_else_46
	li	a0, 1
...
.shadow_check_one_or_matrix_else_48:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_52
	li	a0, 0
...
.shadow_check_one_or_matrix_else_52:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_56
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_57
.shadow_check_one_or_matrix_else_56:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_60
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_61
.shadow_check_one_or_matrix_else_60:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_64
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_65
.shadow_check_one_or_matrix_else_64:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_68
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_69
.shadow_check_one_or_matrix_else_68:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_72
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_73
.shadow_check_one_or_matrix_else_72:
	...
	lw	a1, 16(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.shadow_check_one_or_matrix_cont_75
.shadow_check_one_or_matrix_else_74:
	li	a0, 1
.shadow_check_one_or_matrix_cont_75:
.shadow_check_one_or_matrix_cont_73:
	b	.shadow_check_one_or_matrix_cont_71
.shadow_check_one_or_matrix_else_70:
	li	a0, 1
.shadow_check_one_or_matrix_cont_71:
.shadow_check_one_or_matrix_cont_69:
	b	.shadow_check_one_or_matrix_cont_67
.shadow_check_one_or_matrix_else_66:
	li	a0, 1
.shadow_check_one_or_matrix_cont_67:
.shadow_check_one_or_matrix_cont_65:
	b	.shadow_check_one_or_matrix_cont_63
.shadow_check_one_or_matrix_else_62:
	li	a0, 1
.shadow_check_one_or_matrix_cont_63:
.shadow_check_one_or_matrix_cont_61:
	b	.shadow_check_one_or_matrix_cont_59
.shadow_check_one_or_matrix_else_58:
	li	a0, 1
.shadow_check_one_or_matrix_cont_59:
.shadow_check_one_or_matrix_cont_57:
...
.shadow_check_one_or_matrix_cont_53:
	...
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_77
.shadow_check_one_or_matrix_else_76:
	li	a0, 1
.shadow_check_one_or_matrix_cont_77:
...
.shadow_check_one_or_matrix_else_78:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_79
	li	a0, 0
...
.shadow_check_one_or_matrix_else_79:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_83
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_84
.shadow_check_one_or_matrix_else_83:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_87
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_88
.shadow_check_one_or_matrix_else_87:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_91
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_92
.shadow_check_one_or_matrix_else_91:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_95
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_96
.shadow_check_one_or_matrix_else_95:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_99
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_100
.shadow_check_one_or_matrix_else_99:
	...
	lw	a1, 16(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.shadow_check_one_or_matrix_cont_102
.shadow_check_one_or_matrix_else_101:
	li	a0, 1
.shadow_check_one_or_matrix_cont_102:
.shadow_check_one_or_matrix_cont_100:
	b	.shadow_check_one_or_matrix_cont_98
.shadow_check_one_or_matrix_else_97:
	li	a0, 1
.shadow_check_one_or_matrix_cont_98:
.shadow_check_one_or_matrix_cont_96:
	b	.shadow_check_one_or_matrix_cont_94
.shadow_check_one_or_matrix_else_93:
	li	a0, 1
.shadow_check_one_or_matrix_cont_94:
.shadow_check_one_or_matrix_cont_92:
	b	.shadow_check_one_or_matrix_cont_90
.shadow_check_one_or_matrix_else_89:
	li	a0, 1
.shadow_check_one_or_matrix_cont_90:
.shadow_check_one_or_matrix_cont_88:
	b	.shadow_check_one_or_matrix_cont_86
.shadow_check_one_or_matrix_else_85:
	li	a0, 1
.shadow_check_one_or_matrix_cont_86:
.shadow_check_one_or_matrix_cont_84:
...
.shadow_check_one_or_matrix_else_44:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_104
	li	a0, 0
...
.shadow_check_one_or_matrix_else_104:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_108
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_109
.shadow_check_one_or_matrix_else_108:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_112
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_113
.shadow_check_one_or_matrix_else_112:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_116
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_117
.shadow_check_one_or_matrix_else_116:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_120
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_121
.shadow_check_one_or_matrix_else_120:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_124
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_125
.shadow_check_one_or_matrix_else_124:
	...
	lw	a1, 28(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_128
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_129
.shadow_check_one_or_matrix_else_128:
	...
	lw	a1, 0(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.shadow_check_one_or_matrix_cont_131
.shadow_check_one_or_matrix_else_130:
	li	a0, 1
.shadow_check_one_or_matrix_cont_131:
.shadow_check_one_or_matrix_cont_129:
	b	.shadow_check_one_or_matrix_cont_127
.shadow_check_one_or_matrix_else_126:
	li	a0, 1
.shadow_check_one_or_matrix_cont_127:
.shadow_check_one_or_matrix_cont_125:
	b	.shadow_check_one_or_matrix_cont_123
.shadow_check_one_or_matrix_else_122:
	li	a0, 1
.shadow_check_one_or_matrix_cont_123:
.shadow_check_one_or_matrix_cont_121:
	b	.shadow_check_one_or_matrix_cont_119
.shadow_check_one_or_matrix_else_118:
	li	a0, 1
.shadow_check_one_or_matrix_cont_119:
.shadow_check_one_or_matrix_cont_117:
	b	.shadow_check_one_or_matrix_cont_115
.shadow_check_one_or_matrix_else_114:
	li	a0, 1
.shadow_check_one_or_matrix_cont_115:
.shadow_check_one_or_matrix_cont_113:
	b	.shadow_check_one_or_matrix_cont_111
.shadow_check_one_or_matrix_else_110:
	li	a0, 1
.shadow_check_one_or_matrix_cont_111:
.shadow_check_one_or_matrix_cont_109:
...
.shadow_check_one_or_matrix_cont_105:
	...
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .shadow_check_one_or_matrix_else_133
	li	a0, 0
	b	shadow_check_one_or_matrix_ret
.shadow_check_one_or_matrix_else_133:
	sw	a1, 24(sp)	# save
	li	t6, 99
	bne	a0, t6, .shadow_check_one_or_matrix_else_134
	li	a0, 1
...
.shadow_check_one_or_matrix_else_136:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_140
	li	a0, 0
...
.shadow_check_one_or_matrix_else_140:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_144
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_145
.shadow_check_one_or_matrix_else_144:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_148
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_149
.shadow_check_one_or_matrix_else_148:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_152
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_153
.shadow_check_one_or_matrix_else_152:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_156
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_157
.shadow_check_one_or_matrix_else_156:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_160
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_161
.shadow_check_one_or_matrix_else_160:
	...
	lw	a1, 24(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.shadow_check_one_or_matrix_cont_163
.shadow_check_one_or_matrix_else_162:
	li	a0, 1
.shadow_check_one_or_matrix_cont_163:
.shadow_check_one_or_matrix_cont_161:
	b	.shadow_check_one_or_matrix_cont_159
.shadow_check_one_or_matrix_else_158:
	li	a0, 1
.shadow_check_one_or_matrix_cont_159:
.shadow_check_one_or_matrix_cont_157:
	b	.shadow_check_one_or_matrix_cont_155
.shadow_check_one_or_matrix_else_154:
	li	a0, 1
.shadow_check_one_or_matrix_cont_155:
.shadow_check_one_or_matrix_cont_153:
	b	.shadow_check_one_or_matrix_cont_151
.shadow_check_one_or_matrix_else_150:
	li	a0, 1
.shadow_check_one_or_matrix_cont_151:
.shadow_check_one_or_matrix_cont_149:
	b	.shadow_check_one_or_matrix_cont_147
.shadow_check_one_or_matrix_else_146:
	li	a0, 1
.shadow_check_one_or_matrix_cont_147:
.shadow_check_one_or_matrix_cont_145:
...
.shadow_check_one_or_matrix_cont_141:
	...
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_165
.shadow_check_one_or_matrix_else_164:
	li	a0, 1
.shadow_check_one_or_matrix_cont_165:
...
.shadow_check_one_or_matrix_else_166:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_167
	li	a0, 0
...
.shadow_check_one_or_matrix_else_167:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_171
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_172
.shadow_check_one_or_matrix_else_171:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_175
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_176
.shadow_check_one_or_matrix_else_175:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_179
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_180
.shadow_check_one_or_matrix_else_179:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_183
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_184
.shadow_check_one_or_matrix_else_183:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .shadow_check_one_or_matrix_else_187
	li	a0, 0
	b	.shadow_check_one_or_matrix_cont_188
.shadow_check_one_or_matrix_else_187:
	...
	lw	a1, 24(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.shadow_check_one_or_matrix_cont_190
.shadow_check_one_or_matrix_else_189:
	li	a0, 1
.shadow_check_one_or_matrix_cont_190:
.shadow_check_one_or_matrix_cont_188:
	b	.shadow_check_one_or_matrix_cont_186
.shadow_check_one_or_matrix_else_185:
	li	a0, 1
.shadow_check_one_or_matrix_cont_186:
.shadow_check_one_or_matrix_cont_184:
	b	.shadow_check_one_or_matrix_cont_182
.shadow_check_one_or_matrix_else_181:
	li	a0, 1
.shadow_check_one_or_matrix_cont_182:
.shadow_check_one_or_matrix_cont_180:
	b	.shadow_check_one_or_matrix_cont_178
.shadow_check_one_or_matrix_else_177:
	li	a0, 1
.shadow_check_one_or_matrix_cont_178:
.shadow_check_one_or_matrix_cont_176:
	b	.shadow_check_one_or_matrix_cont_174
.shadow_check_one_or_matrix_else_173:
	li	a0, 1
.shadow_check_one_or_matrix_cont_174:
.shadow_check_one_or_matrix_cont_172:
...
.solve_each_element_else_9:
	...
	fsw	fa0, 40(sp)	# save
	li	t6, -1
	bne	a3, t6, .solve_each_element_else_14
	li	a0, 1
...
.solve_each_element_else_14:
	...
	lw	a0, 4(a1)
	li	t6, -1
	bne	a0, t6, .solve_each_element_else_18
	li	a0, 1
...
.solve_each_element_cont_21:
	...
	lw	a0, 8(a1)
	li	t6, -1
	bne	a0, t6, .solve_each_element_else_35
	li	a0, 1
...
.solve_each_element_else_35:
	...
	lw	a1, 12(sp)	# restore
	call	check_all_inside_2864
	b	.solve_each_element_cont_38
.solve_each_element_else_37:
	li	a0, 0
.solve_each_element_cont_38:
...
.solve_one_or_network_else_1:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_else_3
	b	solve_one_or_network_ret
.solve_one_or_network_else_3:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_else_5
	b	solve_one_or_network_ret
.solve_one_or_network_else_5:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_else_7
	b	solve_one_or_network_ret
.solve_one_or_network_else_7:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_else_9
	b	solve_one_or_network_ret
.solve_one_or_network_else_9:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_else_11
	b	solve_one_or_network_ret
.solve_one_or_network_else_11:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_else_13
	b	solve_one_or_network_ret
.solve_one_or_network_else_13:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_else_15
	b	solve_one_or_network_ret
...
trace_or_matrix_2887:
	...
	lw	a4, 0(a3)
	li	t6, -1
	bne	a4, t6, .trace_or_matrix_else_1
...
.trace_or_matrix_else_1:
	...
	sw	a0, 8(sp)	# save
	li	t6, 99
	bne	a4, t6, .trace_or_matrix_else_3
	lw	a4, 4(a3)
	li	t6, -1
	beq	a4, t6, .trace_or_matrix_cont_5
	slli	a4, a4, 2
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_6
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_7
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_8
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 20(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_9
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 24(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_10
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 28(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_11
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a2, 0(sp)	# restore
	call	solve_one_or_network_2883
.trace_or_matrix_cont_11:
.trace_or_matrix_cont_10:
.trace_or_matrix_cont_9:
.trace_or_matrix_cont_8:
...
.trace_or_matrix_else_12:
	...
	fsw	fa0, 0(a0)
	li	a0, 1
	b	.trace_or_matrix_cont_17
.trace_or_matrix_else_16:
	li	a0, 0
.trace_or_matrix_cont_17:
...
.trace_or_matrix_cont_13:
	...
	lw	a1, 4(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_20
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_21
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_22
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_23
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 20(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_24
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 24(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_25
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 28(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_26
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
...
.trace_or_matrix_cont_4:
	...
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .trace_or_matrix_else_27
	b	trace_or_matrix_ret
.trace_or_matrix_else_27:
	li	t6, 99
	bne	a0, t6, .trace_or_matrix_else_29
	lw	a0, 4(a1)
	li	t6, -1
	beq	a0, t6, .trace_or_matrix_cont_31
	slli	a0, a0, 2
	sw	a1, 20(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_32
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_33
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_34
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 20(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_35
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 24(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_36
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a2, 0(sp)	# restore
	call	solve_one_or_network_2883
.trace_or_matrix_cont_36:
.trace_or_matrix_cont_35:
.trace_or_matrix_cont_34:
.trace_or_matrix_cont_33:
.trace_or_matrix_cont_32:
.trace_or_matrix_cont_31:
...
.trace_or_matrix_else_29:
	...
	lw	a1, 4(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_39
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_40
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_41
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_42
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 20(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_43
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 24(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_44
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
...
solve_each_element_fast_2893:
	...
	lw	a5, 0(t6)
	li	t6, -1
	bne	a5, t6, .solve_each_element_fast_else_1
...
.solve_each_element_fast_else_3:
	...
	fsw	fa0, 0(a0)
	li	a0, 1
	b	.solve_each_element_fast_cont_8
...
.solve_each_element_fast_cont_14:
	li	a0, 1
	b	.solve_each_element_fast_cont_12
.solve_each_element_fast_else_11:
	li	a0, 0
.solve_each_element_fast_cont_12:
...
.solve_each_element_fast_else_15:
	...
	fsw	fa0, 40(sp)	# save
	li	t6, -1
	bne	a2, t6, .solve_each_element_fast_else_20
	li	a0, 1
...
.solve_each_element_fast_else_20:
	...
	lw	a0, 4(a1)
	li	t6, -1
	bne	a0, t6, .solve_each_element_fast_else_24
	li	a0, 1
...
.solve_each_element_fast_cont_27:
	...
	lw	a0, 8(a1)
	li	t6, -1
	bne	a0, t6, .solve_each_element_fast_else_41
	li	a0, 1
...
.solve_each_element_fast_else_41:
	...
	lw	a1, 12(sp)	# restore
	call	check_all_inside_2864
	b	.solve_each_element_fast_cont_44
.solve_each_element_fast_else_43:
	li	a0, 0
.solve_each_element_fast_cont_44:
...
.solve_one_or_network_fast_else_1:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_fast_else_3
	b	solve_one_or_network_fast_ret
.solve_one_or_network_fast_else_3:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_fast_else_5
	b	solve_one_or_network_fast_ret
.solve_one_or_network_fast_else_5:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_fast_else_7
	b	solve_one_or_network_fast_ret
.solve_one_or_network_fast_else_7:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_fast_else_9
	b	solve_one_or_network_fast_ret
.solve_one_or_network_fast_else_9:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_fast_else_11
	b	solve_one_or_network_fast_ret
.solve_one_or_network_fast_else_11:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_fast_else_13
	b	solve_one_or_network_fast_ret
.solve_one_or_network_fast_else_13:
	...
	lw	a1, 0(t6)
	li	t6, -1
	bne	a1, t6, .solve_one_or_network_fast_else_15
	b	solve_one_or_network_fast_ret
...
trace_or_matrix_fast_2901:
	...
	lw	a4, 0(a3)
	li	t6, -1
	bne	a4, t6, .trace_or_matrix_fast_else_1
...
.trace_or_matrix_fast_else_1:
	...
	sw	a0, 8(sp)	# save
	li	t6, 99
	bne	a4, t6, .trace_or_matrix_fast_else_3
	lw	a4, 4(a3)
	li	t6, -1
	beq	a4, t6, .trace_or_matrix_fast_cont_5
	slli	a4, a4, 2
	lwl	a1, min_caml_and_net(a4)
	li	a0, 0
	sw	a3, 12(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_6
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_7
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_8
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 20(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_9
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 24(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_10
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 28(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_11
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a2, 0(sp)	# restore
	call	solve_one_or_network_fast_2897
.trace_or_matrix_fast_cont_11:
.trace_or_matrix_fast_cont_10:
.trace_or_matrix_fast_cont_9:
.trace_or_matrix_fast_cont_8:
...
.trace_or_matrix_fast_else_12:
	...
	fsw	fa0, 0(a0)
	li	a0, 1
	b	.trace_or_matrix_fast_cont_17
.trace_or_matrix_fast_else_16:
	li	a0, 0
.trace_or_matrix_fast_cont_17:
...
.trace_or_matrix_fast_cont_23:
	li	a0, 1
	b	.trace_or_matrix_fast_cont_21
.trace_or_matrix_fast_else_20:
	li	a0, 0
.trace_or_matrix_fast_cont_21:
...
.trace_or_matrix_fast_cont_13:
	...
	lw	a1, 4(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_26
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_27
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_28
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_29
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 20(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_30
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 24(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_31
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 28(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_32
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
...
.trace_or_matrix_fast_cont_4:
	...
	lw	a0, 0(a1)
	li	t6, -1
	bne	a0, t6, .trace_or_matrix_fast_else_33
	b	trace_or_matrix_fast_ret
.trace_or_matrix_fast_else_33:
	li	t6, 99
	bne	a0, t6, .trace_or_matrix_fast_else_35
	lw	a0, 4(a1)
	li	t6, -1
	beq	a0, t6, .trace_or_matrix_fast_cont_37
	slli	a0, a0, 2
	sw	a1, 20(sp)	# save
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_38
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_39
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_40
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 20(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_41
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 24(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_42
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a2, 0(sp)	# restore
	call	solve_one_or_network_fast_2897
.trace_or_matrix_fast_cont_42:
.trace_or_matrix_fast_cont_41:
.trace_or_matrix_fast_cont_40:
.trace_or_matrix_fast_cont_39:
.trace_or_matrix_fast_cont_38:
.trace_or_matrix_fast_cont_37:
...
.trace_or_matrix_fast_else_35:
	...
	lw	a1, 4(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_45
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_46
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_47
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_48
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 20(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_49
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
	...
	lw	a1, 24(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_50
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
...
.get_nvector_second_cont_2:
	...
	fli	fa1, l_data_5
	fdiv	fa0, fa1, fa0
	b	.get_nvector_second_cont_6
.get_nvector_second_else_5:
	fli	fa1, l_data_6
	fdiv	fa0, fa1, fa0
.get_nvector_second_cont_6:
...
.trace_reflections_cont_2:
	...
	lw	a0, 0(a2)
	li	t6, -1
	bne	a0, t6, .trace_reflections_else_5
	li	a0, 0
...
.trace_reflections_else_5:
	...
	sw	a1, 48(sp)	# save
	li	t6, 99
	bne	a0, t6, .trace_reflections_else_7
	li	a0, 1
...
.trace_reflections_else_9:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_13
	li	a0, 0
...
.trace_reflections_else_13:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_17
	li	a0, 0
	b	.trace_reflections_cont_18
.trace_reflections_else_17:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_21
	li	a0, 0
	b	.trace_reflections_cont_22
.trace_reflections_else_21:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_25
	li	a0, 0
	b	.trace_reflections_cont_26
.trace_reflections_else_25:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_29
	li	a0, 0
	b	.trace_reflections_cont_30
.trace_reflections_else_29:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_33
	li	a0, 0
	b	.trace_reflections_cont_34
.trace_reflections_else_33:
	...
	lw	a1, 44(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.trace_reflections_cont_36
.trace_reflections_else_35:
	li	a0, 1
.trace_reflections_cont_36:
.trace_reflections_cont_34:
	b	.trace_reflections_cont_32
.trace_reflections_else_31:
	li	a0, 1
.trace_reflections_cont_32:
.trace_reflections_cont_30:
	b	.trace_reflections_cont_28
.trace_reflections_else_27:
	li	a0, 1
.trace_reflections_cont_28:
.trace_reflections_cont_26:
	b	.trace_reflections_cont_24
.trace_reflections_else_23:
	li	a0, 1
.trace_reflections_cont_24:
.trace_reflections_cont_22:
	b	.trace_reflections_cont_20
.trace_reflections_else_19:
	li	a0, 1
.trace_reflections_cont_20:
.trace_reflections_cont_18:
...
.trace_reflections_cont_14:
	...
	li	a0, 0
	b	.trace_reflections_cont_38
.trace_reflections_else_37:
	li	a0, 1
.trace_reflections_cont_38:
...
.trace_reflections_else_39:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_41
	li	a0, 0
...
.trace_reflections_else_41:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_45
	li	a0, 0
	b	.trace_reflections_cont_46
.trace_reflections_else_45:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_49
	li	a0, 0
	b	.trace_reflections_cont_50
.trace_reflections_else_49:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_53
	li	a0, 0
	b	.trace_reflections_cont_54
.trace_reflections_else_53:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_57
	li	a0, 0
	b	.trace_reflections_cont_58
.trace_reflections_else_57:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .trace_reflections_else_61
	li	a0, 0
	b	.trace_reflections_cont_62
.trace_reflections_else_61:
	...
	lw	a1, 44(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.trace_reflections_cont_64
.trace_reflections_else_63:
	li	a0, 1
.trace_reflections_cont_64:
.trace_reflections_cont_62:
	b	.trace_reflections_cont_60
.trace_reflections_else_59:
	li	a0, 1
.trace_reflections_cont_60:
.trace_reflections_cont_58:
	b	.trace_reflections_cont_56
.trace_reflections_else_55:
	li	a0, 1
.trace_reflections_cont_56:
.trace_reflections_cont_54:
	b	.trace_reflections_cont_52
.trace_reflections_else_51:
	li	a0, 1
.trace_reflections_cont_52:
.trace_reflections_cont_50:
	b	.trace_reflections_cont_48
.trace_reflections_else_47:
	li	a0, 1
.trace_reflections_cont_48:
.trace_reflections_cont_46:
...
.trace_reflections_cont_3:
	...
	sw	a2, 64(sp)	# save
	li	t6, -1
	beq	a0, t6, .trace_reflections_cont_70
	sw	a1, 68(sp)	# save
	li	t6, 99
	bne	a0, t6, .trace_reflections_else_71
	lw	a0, 4(a5)
	li	t6, -1
	beq	a0, t6, .trace_reflections_cont_73
	slli	a0, a0, 2
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	sw	a5, 72(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_reflections_cont_74
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 64(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_reflections_cont_75
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 64(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_reflections_cont_76
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 64(sp)	# restore
	...
	lw	a2, 64(sp)	# restore
	call	solve_one_or_network_fast_2897
.trace_reflections_cont_76:
.trace_reflections_cont_75:
.trace_reflections_cont_74:
.trace_reflections_cont_73:
...
.trace_reflections_else_71:
	...
	lw	a2, 4(a1)
	li	t6, -1
	beq	a2, t6, .trace_reflections_cont_79
	slli	a2, a2, 2
	lwl	a1, min_caml_and_net(a2)
	li	a0, 0
	lw	a2, 64(sp)	# restore
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_reflections_cont_80
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 64(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .trace_reflections_cont_81
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 64(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .trace_reflections_cont_82
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 64(sp)	# restore
...
.trace_ray_cont_79:
	...
	sw	a2, 116(sp)	# save
	li	t6, -1
	beq	a0, t6, .trace_ray_cont_83
	sw	a1, 120(sp)	# save
	li	t6, 99
	bne	a0, t6, .trace_ray_else_84
	lw	a0, 4(a5)
	li	t6, -1
	beq	a0, t6, .trace_ray_cont_86
	slli	a0, a0, 2
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	sw	a5, 124(sp)	# save
...
.trace_diffuse_ray_else_3:
	...
	fli	fa0, l_data_5
	b	.trace_diffuse_ray_cont_10
.trace_diffuse_ray_else_9:
	fli	fa0, l_data_6
.trace_diffuse_ray_cont_10:
...
.trace_diffuse_ray_cont_6:
	...
	lw	a0, 0(a0)
	li	t6, -1
	bne	a0, t6, .trace_diffuse_ray_else_13
	li	a0, 0
	b	.trace_diffuse_ray_cont_14
.trace_diffuse_ray_else_13:
	sw	a1, 36(sp)	# save
	li	t6, 99
	bne	a0, t6, .trace_diffuse_ray_else_15
	li	a0, 1
...
.trace_diffuse_ray_else_17:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_21
	li	a0, 0
...
.trace_diffuse_ray_else_21:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_25
	li	a0, 0
	b	.trace_diffuse_ray_cont_26
.trace_diffuse_ray_else_25:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_29
	li	a0, 0
	b	.trace_diffuse_ray_cont_30
.trace_diffuse_ray_else_29:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_33
	li	a0, 0
	b	.trace_diffuse_ray_cont_34
.trace_diffuse_ray_else_33:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_37
	li	a0, 0
	b	.trace_diffuse_ray_cont_38
.trace_diffuse_ray_else_37:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_41
	li	a0, 0
	b	.trace_diffuse_ray_cont_42
.trace_diffuse_ray_else_41:
	...
	lw	a1, 32(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.trace_diffuse_ray_cont_44
.trace_diffuse_ray_else_43:
	li	a0, 1
.trace_diffuse_ray_cont_44:
.trace_diffuse_ray_cont_42:
	b	.trace_diffuse_ray_cont_40
.trace_diffuse_ray_else_39:
	li	a0, 1
.trace_diffuse_ray_cont_40:
.trace_diffuse_ray_cont_38:
	b	.trace_diffuse_ray_cont_36
.trace_diffuse_ray_else_35:
	li	a0, 1
.trace_diffuse_ray_cont_36:
.trace_diffuse_ray_cont_34:
	b	.trace_diffuse_ray_cont_32
.trace_diffuse_ray_else_31:
	li	a0, 1
.trace_diffuse_ray_cont_32:
.trace_diffuse_ray_cont_30:
	b	.trace_diffuse_ray_cont_28
.trace_diffuse_ray_else_27:
	li	a0, 1
.trace_diffuse_ray_cont_28:
.trace_diffuse_ray_cont_26:
...
.trace_diffuse_ray_cont_22:
	...
	li	a0, 0
	b	.trace_diffuse_ray_cont_46
.trace_diffuse_ray_else_45:
	li	a0, 1
.trace_diffuse_ray_cont_46:
...
.trace_diffuse_ray_else_47:
	...
	lw	a1, 4(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_49
	li	a0, 0
...
.trace_diffuse_ray_else_49:
	...
	lw	a1, 8(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_53
	li	a0, 0
	b	.trace_diffuse_ray_cont_54
.trace_diffuse_ray_else_53:
	...
	lw	a1, 12(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_57
	li	a0, 0
	b	.trace_diffuse_ray_cont_58
.trace_diffuse_ray_else_57:
	...
	lw	a1, 16(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_61
	li	a0, 0
	b	.trace_diffuse_ray_cont_62
.trace_diffuse_ray_else_61:
	...
	lw	a1, 20(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_65
	li	a0, 0
	b	.trace_diffuse_ray_cont_66
.trace_diffuse_ray_else_65:
	...
	lw	a1, 24(a0)
	li	t6, -1
	bne	a1, t6, .trace_diffuse_ray_else_69
	li	a0, 0
	b	.trace_diffuse_ray_cont_70
.trace_diffuse_ray_else_69:
	...
	lw	a1, 32(sp)	# restore
	call	shadow_check_one_or_group_2873
	b	.trace_diffuse_ray_cont_72
.trace_diffuse_ray_else_71:
	li	a0, 1
.trace_diffuse_ray_cont_72:
.trace_diffuse_ray_cont_70:
	b	.trace_diffuse_ray_cont_68
.trace_diffuse_ray_else_67:
	li	a0, 1
.trace_diffuse_ray_cont_68:
.trace_diffuse_ray_cont_66:
	b	.trace_diffuse_ray_cont_64
.trace_diffuse_ray_else_63:
	li	a0, 1
.trace_diffuse_ray_cont_64:
.trace_diffuse_ray_cont_62:
	b	.trace_diffuse_ray_cont_60
.trace_diffuse_ray_else_59:
	li	a0, 1
.trace_diffuse_ray_cont_60:
.trace_diffuse_ray_cont_58:
	b	.trace_diffuse_ray_cont_56
.trace_diffuse_ray_else_55:
	li	a0, 1
.trace_diffuse_ray_cont_56:
.trace_diffuse_ray_cont_54:
...
iter_trace_diffuse_rays_2937:
	...
	sw	a4, 28(sp)	# save
	li	t6, -1
	beq	a0, t6, .iter_trace_diffuse_rays_cont_3
	sw	a1, 32(sp)	# save
	li	t6, 99
	bne	a0, t6, .iter_trace_diffuse_rays_else_4
	lw	a0, 4(a6)
	li	t6, -1
	beq	a0, t6, .iter_trace_diffuse_rays_cont_6
	slli	a0, a0, 2
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	sw	a6, 36(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_7
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 24(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_8
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 24(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_9
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 24(sp)	# restore
	...
	lw	a2, 24(sp)	# restore
	call	solve_one_or_network_fast_2897
.iter_trace_diffuse_rays_cont_9:
.iter_trace_diffuse_rays_cont_8:
.iter_trace_diffuse_rays_cont_7:
.iter_trace_diffuse_rays_cont_6:
...
.iter_trace_diffuse_rays_else_4:
	...
	lw	a2, 4(a1)
	li	t6, -1
	beq	a2, t6, .iter_trace_diffuse_rays_cont_12
	slli	a2, a2, 2
	lwl	a1, min_caml_and_net(a2)
	li	a0, 0
	lw	a2, 24(sp)	# restore
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_13
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 24(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_14
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 24(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_15
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 24(sp)	# restore
...
.iter_trace_diffuse_rays_cont_17:
	beq	a0, zero, .iter_trace_diffuse_rays_cont_18
	lda	a0, min_caml_intersected_object_id
	lw	a0, 0(a0)
	slli	a0, a0, 2
	lwl	a0, min_caml_objects(a0)
	...
	fli	fa0, l_data_5
	b	.iter_trace_diffuse_rays_cont_24
.iter_trace_diffuse_rays_else_23:
	fli	fa0, l_data_6
.iter_trace_diffuse_rays_cont_24:
...
.iter_trace_diffuse_rays_cont_20:
	...
	lw	a1, 0(a1)
	call	shadow_check_one_or_matrix_2876
	bne	a0, zero, .iter_trace_diffuse_rays_cont_27
	lda	a0, min_caml_nvector
	lda	a1, min_caml_light
	flw	fa0, 0(a0)
	flw	fa1, 0(a1)
...
.iter_trace_diffuse_rays_cont_28:
	...
	fadd	fa0, fa1, fa0
	fsw	fa0, 8(a0)
.iter_trace_diffuse_rays_cont_27:
.iter_trace_diffuse_rays_cont_18:
...
.iter_trace_diffuse_rays_else_1:
	...
	sw	a4, 60(sp)	# save
	li	t6, -1
	beq	a0, t6, .iter_trace_diffuse_rays_cont_29
	sw	a1, 64(sp)	# save
	li	t6, 99
	bne	a0, t6, .iter_trace_diffuse_rays_else_30
	lw	a0, 4(a6)
	li	t6, -1
	beq	a0, t6, .iter_trace_diffuse_rays_cont_32
	slli	a0, a0, 2
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	sw	a6, 68(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_33
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 56(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_34
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 56(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_35
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 56(sp)	# restore
	...
	lw	a2, 56(sp)	# restore
	call	solve_one_or_network_fast_2897
.iter_trace_diffuse_rays_cont_35:
.iter_trace_diffuse_rays_cont_34:
.iter_trace_diffuse_rays_cont_33:
.iter_trace_diffuse_rays_cont_32:
...
.iter_trace_diffuse_rays_else_30:
	...
	lw	a2, 4(a1)
	li	t6, -1
	beq	a2, t6, .iter_trace_diffuse_rays_cont_38
	slli	a2, a2, 2
	lwl	a1, min_caml_and_net(a2)
	li	a0, 0
	lw	a2, 56(sp)	# restore
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_39
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 56(sp)	# restore
	...
	lw	a1, 12(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_40
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 56(sp)	# restore
	...
	lw	a1, 16(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_41
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 56(sp)	# restore
...
.iter_trace_diffuse_rays_cont_43:
	...
	fli	fa0, l_data_5
	b	.iter_trace_diffuse_rays_cont_50
.iter_trace_diffuse_rays_else_49:
	fli	fa0, l_data_6
.iter_trace_diffuse_rays_cont_50:
...
try_exploit_neighbors_2975:
	...
	li	a6, 1
	b	.try_exploit_neighbors_cont_8
.try_exploit_neighbors_else_7:
	li	a6, 0
.try_exploit_neighbors_cont_8:
	b	.try_exploit_neighbors_cont_6
.try_exploit_neighbors_else_5:
	li	a6, 0
.try_exploit_neighbors_cont_6:
	b	.try_exploit_neighbors_cont_4
.try_exploit_neighbors_else_3:
	li	a6, 0
.try_exploit_neighbors_cont_4:
...
.try_exploit_neighbors_cont_13:
	...
	li	a6, 1
	b	.try_exploit_neighbors_cont_21
.try_exploit_neighbors_else_20:
	li	a6, 0
.try_exploit_neighbors_cont_21:
	b	.try_exploit_neighbors_cont_19
.try_exploit_neighbors_else_18:
	li	a6, 0
.try_exploit_neighbors_cont_19:
	b	.try_exploit_neighbors_cont_17
.try_exploit_neighbors_else_16:
	li	a6, 0
.try_exploit_neighbors_cont_17:
...
.scan_pixel_cont_4:
	...
	lw	s6, 4(a0)
	lw	s7, 0(s5)
	blt	s7, zero, .scan_pixel_cont_13
	lw	s7, 0(s4)
	sw	a0, 28(sp)	# save
	sw	s3, 32(sp)	# save
	sw	s6, 36(sp)	# save
...
.scan_pixel_cont_14:
	lw	a0, 56(sp)	# restore
	lw	a1, 4(a0)
	blt	a1, zero, .scan_pixel_cont_15
	lw	a1, 52(sp)	# restore
	lw	a2, 4(a1)
...
.scan_pixel_cont_16:
	...
	lw	a0, 56(sp)	# restore
	lw	a0, 8(a0)
	blt	a0, zero, .scan_pixel_cont_17
	lw	a0, 52(sp)	# restore
	lw	a0, 8(a0)
...
.scan_pixel_else_11:
	...
	li	s1, 1
	b	.scan_pixel_cont_27
.scan_pixel_else_26:
	li	s1, 0
.scan_pixel_cont_27:
	b	.scan_pixel_cont_25
.scan_pixel_else_24:
	li	s1, 0
.scan_pixel_cont_25:
	b	.scan_pixel_cont_23
.scan_pixel_else_22:
	li	s1, 0
.scan_pixel_cont_23:
...
.scan_pixel_cont_21:
	...
	lw	s6, 4(a0)
	lw	s7, 0(s5)
	blt	s7, zero, .scan_pixel_cont_30
	lw	s7, 0(s4)
	sw	a0, 64(sp)	# save
	sw	s4, 68(sp)	# save
	sw	s5, 72(sp)	# save
...
.scan_pixel_cont_31:
	...
	lw	a0, 72(sp)	# restore
	lw	a0, 4(a0)
	blt	a0, zero, .scan_pixel_cont_32
	lw	a0, 68(sp)	# restore
	lw	a0, 4(a0)
...
.rt_cont_48:
	...
	li	a2, 8
	call	calc_dirvec_rows_3041
	lw	a0, 188(sp)	# restore
	lw	a1, 16(a0)
	lw	a0, 476(a1)
	sw	a1, 232(sp)	# save
	call	setup_dirvec_constants_2837
	li	a1, 118
	lw	a0, 232(sp)	# restore
	call	init_dirvec_constants_3052
	lw	a0, 188(sp)	# restore
	lw	a0, 12(a0)
	li	a1, 119
...
.rt_else_65:
	...
	fsw	fa0, 256(sp)	# save
	call	min_caml_float_of_int
	flw	fa1, 256(sp)	# restore
	fmul	fa0, fa1, fa0
	lw	a0, 240(sp)	# restore
	flw	fa1, 0(a0)
	fmul	fa1, fa0, fa1
	lw	a3, 244(sp)	# restore
	flw	fa2, 0(a3)
	fadd	fa1, fa1, fa2
	flw	fa2, 4(a0)
	fmul	fa2, fa0, fa2
