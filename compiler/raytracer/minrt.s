...
.trace_or_matrix_else_1:
	...
	lw	a4, 4(a3)
	li	t6, -1
	beq	a4, t6, .trace_or_matrix_cont_4
	slli	a4, a4, 2
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_4
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
...
.trace_or_matrix_else_27:
	...
	lw	a0, 4(a1)
	li	t6, -1
	beq	a0, t6, .trace_or_matrix_cont_30
	slli	a0, a0, 2
	sw	a1, 20(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_cont_30
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
...
.trace_or_matrix_fast_else_1:
	...
	lw	a4, 4(a3)
	li	t6, -1
	beq	a4, t6, .trace_or_matrix_fast_cont_4
	slli	a4, a4, 2
	lwl	a1, min_caml_and_net(a4)
	li	a0, 0
	sw	a3, 12(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_4
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
...
.trace_or_matrix_fast_else_33:
	...
	lw	a0, 4(a1)
	li	t6, -1
	beq	a0, t6, .trace_or_matrix_fast_cont_36
	slli	a0, a0, 2
	sw	a1, 20(sp)	# save
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_or_matrix_fast_cont_36
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 0(sp)	# restore
...
.trace_reflections_cont_3:
	...
	lw	a0, 4(a5)
	li	t6, -1
	beq	a0, t6, .trace_reflections_cont_72
	slli	a0, a0, 2
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	sw	a5, 72(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .trace_reflections_cont_72
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 64(sp)	# restore
...
iter_trace_diffuse_rays_2937:
	...
	lw	a0, 4(a6)
	li	t6, -1
	beq	a0, t6, .iter_trace_diffuse_rays_cont_5
	slli	a0, a0, 2
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	sw	a6, 36(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_5
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 24(sp)	# restore
...
.iter_trace_diffuse_rays_else_1:
	...
	lw	a0, 4(a6)
	li	t6, -1
	beq	a0, t6, .iter_trace_diffuse_rays_cont_31
	slli	a0, a0, 2
	lwl	a1, min_caml_and_net(a0)
	li	a0, 0
	sw	a6, 68(sp)	# save
	...
	lw	a1, 8(a0)
	li	t6, -1
	beq	a1, t6, .iter_trace_diffuse_rays_cont_31
	slli	a1, a1, 2
	lwl	a1, min_caml_and_net(a1)
	li	a0, 0
	lw	a2, 56(sp)	# restore
...
init_line_elements_3018:
	...
	sw	a2, 0(t6)
	addi	a1, a1, -1
	blt	a1, zero, init_line_elements_ret
	fsw	fa0, 0(sp)	# save
	sw	a0, 4(sp)	# save
	sw	a1, 8(sp)	# save
